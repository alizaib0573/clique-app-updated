...
const InteractiveGradient = ({
  ...
  const sceneDataRef = useRef<{
    fluidTarget1: THREE.WebGLRenderTarget<THREE.Texture<unknown>>;
    fluidTarget2: THREE.WebGLRenderTarget<THREE.Texture<unknown>>;
  ...
  return (
    <div ref={canvasRef} className="absolute top-0 left-0 w-screen h-svh" />
  );
};
